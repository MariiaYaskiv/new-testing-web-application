...
describe('Test suite 3 API', function () {
    ...
    it('Verify the new post exists', () => {
        ...
        cy.request('PUT', 'https://jsonplaceholder.typicode.com/posts/' + newId).then((response) => {
           // expect(followRedirect: false)
    ...
    it('Verify the new post exists', () => {
        cy.request("PUT", "https://jsonplaceholder.typicode.com/posts/" + newId, 
